...
5. GCP 사용의 문제점 : 2팀의 팀원 5명이 하나의 VM 환경을 공유함. 용량 100GB 제한.
 ...
 ㄴ. GCS를 이용하여 GCP에서 생성되는 데이터를 실시간으로 공유할 수 있는 환경을 구성한다. VM이 한계 사용량을 넘어서서 사용하게 되지 못할 때 데이터가 보존될 수 있다. 지원되지 않는 관계로 Google Drive 또는 Naver Cloud로 대체함. 로컬 -> GCP 환경을
